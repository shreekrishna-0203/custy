...
export default function Register() {
  ...
  return (
    <div className="w-screen h-screen flex items-center
     justify-center bg-gradient-to-br from-slate-50 via-gray-50
      to-black text-white overflow-hidden">
        ...
        <form onSubmit={hRegister} className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              className="p-3 border border-gray-300 rounded w-full f
              ocus:outline-none focus:ring-2 focus:ring-blue-500 text-black"
              value={password}
